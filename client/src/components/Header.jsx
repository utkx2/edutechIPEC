    ...
    <div>
      <div className='h-[85px] bg-white flex items-center justify-between px-8'>
        ...
        <div className='flex items-center gap-4 text-[12px]'>
          ...
          {auth ? (
            <>
              <div className="text-white bg-[#1f1d5a] cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={logout}
              >Logout</div>
              {
                auth.userRole == "admin" ? (<Link to='/dashboard/users' className="text-white bg-[#1f1d5a] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >Dashboard</Link>) : (
                  <></>
                )}
              {
                auth.userRole == "student" ? (<Link to='/exam' className="text-white bg-[#1f1d5a] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >Exams</Link>) : (
                  <></>
                )}
            </>
