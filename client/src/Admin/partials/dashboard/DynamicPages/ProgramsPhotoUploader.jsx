...
export default function ProgramsPhotoUploader({ photos, onChange, index }) {
    ...
    function uploadPhoto(ev) {
        ...
        axios.post(`${BASE_URL}home/uploadImage`, data, {
            ...
            // console.log(photos.Programs);
            // console.log(index);
            photos.Programs[index].image = filenames[0];
...
ProgramsPhotoUploader.propTypes = {
