...
function FacultyRegistration() {
  ...
  const showDetails = (userId) => {
    navigate(`/dashboard/faculty-registration/${userId}`);
  };
  ...
  const downloadAsPDF = () => {
    ...
    const headers = ["Faulty", "Email", "Phone", "Gender", "Category", "DOB", "Qualification", "Previous Experience", "Address Line 1", "Address Line 2", "Address Line 3", "City", "State", "Zipcode", "Message"];
          ...
          <div className="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
            ...
            <div className="grid gap-6 grid-cols-15">
              ...
              <section className="container p-6 mx-auto overflow-x-auto font-mono">
                <h1 className="mb-4 text-xl font-bold">All Faculty</h1>
                <div className="flex flex-col mb-4 md:flex-row md:items-center md:justify-between">
                  ...
                  <div>
                    <button
                      className="px-4 py-2 mb-2 mr-4 font-bold text-white bg-green-700 rounded focus:outline-none focus:ring-2 md:mb-0 md:mr-2"
